...
def update_chatbot_config(current_user, client_id):
    ...
    allowed_fields = [
        ...
        # Theme / Look & Feel
        'font_family', 'custom_font_url', 'header_text_color', 'header_style',
        'bubble_size', 'bubble_icon', 'bubble_style',
        'window_bg_color', 'window_width', 'window_height', 'window_border_radius',
        'message_border_radius', 'user_msg_bg_color', 'user_msg_text_color',
        'bot_msg_bg_color', 'bot_msg_text_color', 'send_btn_style',
        'input_border_color', 'input_bg_color', 'input_text_color',
        'powered_by_visible', 'shadow_style', 'border_style', 'border_color',
        # Behavior
        'auto_open_delay', 'show_on_mobile',
        'trigger_mode', 'trigger_delay_seconds', 'trigger_page_views', 'reopen_after_close',
...
def get_widget_config(chatbot_id):
    ...
    return jsonify({
        ...
        # Theme / Look & Feel
        'font_family': getattr(config, 'font_family', 'system') or 'system',
        'custom_font_url': getattr(config, 'custom_font_url', None),
        'header_text_color': getattr(config, 'header_text_color', '#ffffff') or '#ffffff',
        'header_style': getattr(config, 'header_style', 'gradient') or 'gradient',
        'bubble_size': getattr(config, 'bubble_size', '60') or '60',
        'bubble_icon': getattr(config, 'bubble_icon', 'chat') or 'chat',
        'bubble_style': getattr(config, 'bubble_style', 'gradient') or 'gradient',
        'window_bg_color': getattr(config, 'window_bg_color', '#ffffff') or '#ffffff',
        'window_width': getattr(config, 'window_width', '380') or '380',
        'window_height': getattr(config, 'window_height', '520') or '520',
        'window_border_radius': getattr(config, 'window_border_radius', '16') or '16',
        'message_border_radius': getattr(config, 'message_border_radius', '16') or '16',
        'user_msg_bg_color': getattr(config, 'user_msg_bg_color', None),
        'user_msg_text_color': getattr(config, 'user_msg_text_color', '#ffffff') or '#ffffff',
        'bot_msg_bg_color': getattr(config, 'bot_msg_bg_color', '#f1f5f9') or '#f1f5f9',
        'bot_msg_text_color': getattr(config, 'bot_msg_text_color', '#1e293b') or '#1e293b',
        'send_btn_style': getattr(config, 'send_btn_style', 'round') or 'round',
        'input_border_color': getattr(config, 'input_border_color', '#e2e8f0') or '#e2e8f0',
        'input_bg_color': getattr(config, 'input_bg_color', '#ffffff') or '#ffffff',
        'input_text_color': getattr(config, 'input_text_color', '#1e293b') or '#1e293b',
        'powered_by_visible': getattr(config, 'powered_by_visible', True) if hasattr(config, 'powered_by_visible') else True,
        'shadow_style': getattr(config, 'shadow_style', 'medium') or 'medium',
        'border_style': getattr(config, 'border_style', 'none') or 'none',
        'border_color': getattr(config, 'border_color', '#e2e8f0') or '#e2e8f0',
        # Behavior
        'auto_open_delay': config.auto_open_delay or 0,
        'trigger_mode': getattr(config, 'trigger_mode', 'disabled') or 'disabled',
        'trigger_delay_seconds': getattr(config, 'trigger_delay_seconds', 60) or 60,
        'trigger_page_views': getattr(config, 'trigger_page_views', 2) or 2,
        'reopen_after_close': getattr(config, 'reopen_after_close', False) or False,
        'guided_flow_enabled': getattr(config, 'guided_flow_enabled', False) or False,
        'guided_flow': json.loads(config.guided_flow_json) if getattr(config, 'guided_flow_json', None) else None,
