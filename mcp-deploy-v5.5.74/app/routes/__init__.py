...
def register_routes(app: Flask):
    ...
    # Alias: /api/onboarding/intake -> creates client (simplified)
    ...
    @onboarding_bp.route('/intake', methods=['POST'])
    @token_required
    def onboarding_intake_alias(current_user):
        """Alias for /api/intake/pipeline"""
        ...
        return jsonify({
            ...
            'message': 'Client created via onboarding'
        }), 201
